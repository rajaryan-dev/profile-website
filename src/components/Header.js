          ...
          <Col lg={8} md={10} className="mx-auto text-center">
            <div className="hero-text" data-aos="fade-up" data-aos-delay="200">
              ...
              <p className="hero-description">
                ...
                the latest technologies. Currently pursuing B.Tech (4th year) in
              ...
              >
                ...
                <a
                  href="https://linkedin.com/in/raj-aryan-1b17732ab"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="social-link"
                >
                ...
                <a
                  href="mailto:aryan.contact.raj@gmail.com"
                  className="social-link"
                >
                  <FaEnvelope size={24} />
                </a>
                <a
                  href="https://wa.me/917250281353"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="social-link"
                >
